...
# Broad NYC bounding box to remove outliers
...
def eval_split(name: str, y_true: pd.Series, y_pred: np.ndarray) -> dict:
    # Clip for Poisson deviance stability
...
# Alpha selection using validation MPD
...
# 2) Actual vs Predicted scatter (Test)
